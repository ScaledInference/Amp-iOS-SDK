...
typedef SWIFT_ENUM(NSInteger, BuiltinEvent, closed) {
  BuiltinEventTap = 0,
  BuiltinEventAmpSession = 1,
  BuiltinEventConnectionLatency1 = 2,
  BuiltinEventConnectionLatency2 = 3,
};
...
+ (Config * _Nonnull)ampConfigWithBuiltinEvents:(NSArray<NSNumber *> * _Nullable)builtinEvents logLevel:(enum LogLevel)logLevel sessionTTL:(NSNumber * _Nullable)sessionTTL sessionLifetime:(NSNumber * _Nullable)sessionLifetime SWIFT_WARN_UNUSED_RESULT;
...
- (ConfigBuilder * _Nonnull)setWithBuiltinEvents:(NSArray<NSNumber *> * _Nonnull)builtinEvents SWIFT_WARN_UNUSED_RESULT;
